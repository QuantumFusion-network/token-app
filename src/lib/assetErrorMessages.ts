export const ASSET_ERROR_MESSAGES: Record<string, string> = {
  ...
  'Assets.InUse':
    'This asset is currently in use and cannot be destroyed.',
  'Assets.AssetNotLive':
    'This asset has been frozen and cannot be used for transactions.',
  'Assets.Frozen': 'This asset or account is frozen.',

  // Balance errors
  'Assets.BalanceLow': 'Insufficient balance to perform this operation.',
  'Assets.WouldDie':
    'This operation would bring the balance below the minimum required amount.',
  'Assets.NoAccount':
    'No account exists for this asset. The account may need to be created first.',

  // Metadata errors
  'Assets.BadMetadata':
    'Invalid metadata format. Check that name and symbol are correctly formatted.',
